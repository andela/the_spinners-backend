...
const requestActionEmailTemplate = (requesterNames, notification, unsubscribeUrl, data) => `<body style="margin: 0; padding: 0;">
                  ...
                  <tr><td align="left" style="font-family: Arial, sans-serif; font-size: 18px; color: #050505;">
                      ...
                      <table style="font-family: arial, sans-serif; width: 70%;">
                          <tr style = "background-color: #dddddd;">
                            <td style = "border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight:bold;"> Status:</td>
                            <td style = "border: 1px solid #dddddd; text-align: left; padding: 8px;"> ${data.status}</td>
                          </tr>
                      </table>
...
export default requestActionEmailTemplate;
